...
class ManajemenBisnis extends StatelessWidget {
  @override
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        child: Container(
                          child: Image.asset('images/feb/mb.png'),
                          padding: EdgeInsets.only(bottom: 30),
                        ),
                      ),
                      Text("D3 - Manajemen Bisnis",
